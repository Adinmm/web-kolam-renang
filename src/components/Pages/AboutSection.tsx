        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              Sejak 2014, AquaSwim Club telah menjadi rumah bagi ratusan perenang dari berbagai usia dan tingkat kemampuan.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                AquaSwim Club didirikan dengan visi untuk menghadirkan pembelajaran renang berkualitas tinggi 
